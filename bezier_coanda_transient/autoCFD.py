...
mdot = 0.003
pulse_start = 0.2
pulse_duration = 0.0015
parallel = True

mesh_command = 'python3 autoMesh.py --clean true --airfoil naca0015 --mdot 0.003 --meanFlow 30.0'
blockmesh = 'blockMesh'
...
if parallel:
    ...
    save_command = 'python3 autoMesh.py --store true --runName std_init_3 --airfoil naca0015'
    os.system(decompose)
    ...
    # else:
    #     exit()
    os.system('rhoPimpleFoam -postProcess -func forces -case /media/james/Data/james/completed_cases/era/std_init_3/')
else:
