...
mdot_sweep = np.array([0,0.002,0.0025,0.003,0.0035,0.004,0.0045,0.005,0.0055,0.006])
flow_speed = 25
print(mdot_sweep)
...
for i in mdot_sweep:
    ...
    save_command = "python3 autoMesh.py -save /steady/{}kgps_{}mps".format(i,flow_speed)
