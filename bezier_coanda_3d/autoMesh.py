...
def store(retain,name):
    ...
    for item in dirs:
        if item[0:9] == 'processor':
            delete.append(item)
    target = name
    casefile = "/home/james/Documents/research/completed_cases/steady_redo/{}/".format(target)
...
def make_3dpoints(points_back,span,spanwidths=1):
    for i in range(np.shape(pback)[0]*2):
        if i % 2 == 0:
            pointsdef.append('\t\t({} {} {})\t//\t{}\n'.format(points_back[int(i/2),0],points_back[int(i/2),1], back - spanwidths*span, i))
        else:
            pointsdef.append('\t\t({} {} {})\t//\t{}\n'.format(points_back[int((i-1)/2),0],points_back[int((i-1)/2),1], front + spanwidths*span, i))
...
blocks = [
    'blocks\n(\n',
    '\t\thex ( 4 28  8  0  5 29  9  1) ({} {} {}) edgeGrading (((.5 .5 {}) (.5 .5 {})) {}  {} ((.5 .5 {}) (.5 .5 {})) {} {} {} {} 1 1 1 1) // 0\n'.format(blocks_x_L, blocks_y_L, blocks_z, egrade_x, 1/egrade_x, 1/egrade_o, 1/egrade_o, egrade_x, 1/egrade_x, grade_y, grade_y, grade_y, grade_y),
    '\t\thex (28 26 10  8 29 27 11  9) ({} {} {}) simpleGrading ({}  {}  1) // 1\n'.format(blocks_x_flat, blocks_y_R, blocks_z, 1/grade_x_L, grade_y),
    '\t\thex (26 34 14 10 27 35 15 11) ({} {} {}) simpleGrading ( 1  {}  1) // 2\n'.format(blocks_x_R, blocks_y_R, blocks_z, grade_y),
    '\t\thex (34 36  2 14 35 37  3 15) ({} {} {}) simpleGrading ({}  {}  1) // 3\n'.format(blocks_x_flat, blocks_y_L, blocks_z, grade_x_L, grade_y),
    '\t\thex (36  4  0  2 37  5  1  3) ({} {} {}) edgeGrading (((.5 .5 {}) (.5 .5 {})) {}  {} ((.5 .5 {}) (.5 .5 {})) {} {} {} {} 1 1 1 1) // 4\n'.format(blocks_x_L, blocks_y_L, blocks_z, egrade_x, 1/egrade_x, egrade_o, egrade_o, egrade_x, 1/egrade_x, grade_y, grade_y, grade_y, grade_y),
    '\t\thex (24 32 34 26 25 33 35 27) ({} {} {}) simpleGrading ( 1  {}  1) // 5\n'.format(blocks_x_R, blocks_y_co-1, blocks_z, 2),
    '\t\thex (22 30 32 24 23 31 33 25) ({} {} {}) simpleGrading ( 1  {}  1) // 6\n'.format(blocks_x_R, blocks_y_co, blocks_z, 2),
    ');\n\n'
]
